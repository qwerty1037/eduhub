                        ...
                        builder: (controller) {
                          return Expanded(
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                final url =
                                    Uri.parse('http://$HOST/api/auth/login');
                                ...
                                if (response.statusCode == 200) {
                                  ...
                                  String? uid = controller.getCookieValue(
                                      cookieHeader, "uid");
                                  String? accessToken =
                                      controller.getCookieValue(
                                          cookieHeader, "accessToken");
                                  String? refreshToken =
                                      controller.getCookieValue(
                                          cookieHeader, "refreshToken");
                                  if (uid == null ||
                                      accessToken == null ||
                                      refreshToken == null) {
                                    ...
                                    controller.saveCookieToSecureStorage(
